...
export const NeovimIcon: Icon = (props) => {
  const id = useId();
  const gradientLeftId = `${id}-nvim-left`;
  const gradientRightId = `${id}-nvim-right`;
  const gradientCrossId = `${id}-nvim-cross`;

  return (
    <svg {...props} viewBox="0 0 602 734" fill="none">
      <defs>
        <linearGradient id={gradientLeftId} x1="50%" y1="0%" x2="50%" y2="100%">
          <stop stopColor="#16B0ED" stopOpacity="0.800235524" offset="0%" />
          <stop stopColor="#0F59B2" stopOpacity="0.83700023" offset="100%" />
        </linearGradient>
        <linearGradient id={gradientRightId} x1="50%" y1="0%" x2="50%" y2="100%">
          <stop stopColor="#7DB643" offset="0%" />
          <stop stopColor="#367533" offset="100%" />
        </linearGradient>
        <linearGradient id={gradientCrossId} x1="50%" y1="0%" x2="50%" y2="100%">
